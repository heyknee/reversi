...
/* Leave Room: when a web page disconnects alert everyone */
...
/* uninvite command */
	...
	uninvited: {
		'result': 'success',
		'socket_id' : the socket id of the person doing the uniniting 
	}
	or {
		'result': 'success',
		'socket_id' : failure message
...
game_start_response: {
	...
	*/
	...
	socket.on('game_start', function(payload){
		...
		/* If everything is ok respond to the gamestaet that is was succesful */
